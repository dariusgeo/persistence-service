package edu.geodani.persitence.config;

import edu.geodani.persitence.messaging.ReportMessageHandler;
import edu.geodani.persitence.messaging.TransactionMessageHandler;
